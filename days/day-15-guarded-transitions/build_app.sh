#!/bin/bash
#
# Собирает «День 15.app» — контролируемые переходы.
#
#   ./build_app.sh
#   open "dist/День 15.app"
...
<plist version="1.0">
<dict>
  <key>CFBundleName</key>                <string>День 15</string>
  <key>CFBundleDisplayName</key>         <string>День 15 — контролируемые переходы</string>
  <key>CFBundleIdentifier</key>          <string>local.aiadvent.day15</string>
...
echo
echo "Проверка дня: попросите написать код на этапе планирования —"
echo "агент откажется. Нажмите «Утвердить», и замок на переходе откроется."
